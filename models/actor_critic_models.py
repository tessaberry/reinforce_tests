...
class ActorCriticBase(tf.keras.Model):
    ...
    def call(self, inputs):
        ...
        raise Exception("ActorCriticBase is an abstract base class")
...
class SeparateActorCritic(ActorCriticBase):
    '''
    This method builds seperate Actor and Critic models
    It can have convolutional layers followed by dense layers

    to define the convolutional layers input a list tuples whose length is the number of convolutional layers
    each tuple represents (n_filters, kernel, strides)


    Inputs:
        num_actions: number of actions to be predicted
        actor_conv_layers: list of tuples or None for the actor
        actor_dense_layers: list representing number of dense layers for the actor
        critic_conv_layers: list of tuples or None for the critic
        critic_dense_layers: list representing number of dense layers for the critic


    Output:
        actor_logits: logits representing the log odds probability of taking an action (take the best one)
        value_out: the predicted value of the best action
    '''
    def __init__(self,
                 num_actions,
